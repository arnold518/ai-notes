...
!!! definition "Definition 8.4 : DnCNN"
    ...
    ![](./assets/8.1.png){: .center style="width:70%;"}
    ...
    ![](./assets/8.2.png){: .center style="width:100%;"}
...
!!! definition "Definition 8.7 : VDSR"
    ...
    ![](./assets/8.5.png){: .center style="width:70%;"}
    ...
    ![](./assets/8.6.png){: .center style="width:100%;"}
...
!!! example "Example 8.8 : SRGAN"
    ...
    ![](./assets/8.7.png){: .center style="width:100%;"}
    ![](./assets/8.8.png){: .center style="width:100%;"}
    ![](./assets/8.9.png){: .center style="width:100%;"}
...
!!! example "Example 8.9 : Image Colorization"
    ![](./assets/8.10.png){: .center style="width:100%;"}

    (R. Zhang, P. Isola, and A. A. Efros, Colorful image colorization, ECCV, 2016.)

!!! example "Example 8.10 : Image Inpainting"

    ![](./assets/8.11.png){: .center style="width:100%;"}
    ![](./assets/8.12.png){: .center style="width:100%;"}
...
!!! definition "Definition 8.15 : Transposed Convolution"
    ...
    ![](./assets/8.13.png){: .center style="width:100%;"}
    ![](./assets/8.14.png){: .center style="width:100%;"}

- Convolution Visualized

![](./assets/8.15.gif){: .center style="width:50%;"}

- Transpose Convolution Visualized

![](./assets/8.16.gif){: .center style="width:100%;"}
...
![](./assets/8.17.png){: .center style="width:50%;"}
...
!!! concept "Concept 8.17 : Upsampling : Nearest Neighbor"
    ...
    ![](./assets/8.18.png){: .center style="width:75%;"}
...
!!! concept "Concept 8.18 : Upsampling : Bilinear Interpolation"
    ...
    ![](./assets/8.19.png){: .center style="width:75%;"}
...
!!! definition "Definition 8.21 : Object Detection"
    **Object detection** detects many objects, with the same class often repeated, usually via bounding boxes.
    ...
    ![](./assets/8.22.png){: .center style="width:100%;"}
...
!!! definition "Definition 8.22 : Image Segmentation"
    **Instance segmentation** distinguishes multiple instances of the same object type.
    ...
    ![](./assets/8.23.png){: .center style="width:100%;"}
...
!!! definition "Definition 8.23 : Pascal VOC"
    ...
    ![](./assets/8.24.png){: .center style="width:40%;"}
...
!!! definition "Definition 8.25 : U-Net"
    ...
    ![](./assets/8.25.jpg){: .center style="width:100%;"}
...
!!! definition "Definition 8.27 : FastMRI Dataset"
    ...
    ![](./assets/8.26.jpg){: .center style="width:70%;"}
...
!!! concept "Concept 8.29 : U-Net is used for inverse problems."
    ...
    ![](./assets/8.27.jpg){: .center style="width:100%;"}
    ...
    ![](./assets/8.28.png){: .center style="width:100%;"}
    ![](./assets/8.29.png){: .center style="width:70%;"}
