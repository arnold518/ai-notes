...
\begin{myconceptblock}{5.8}{Pooling}
    ...
    \begin{figure}[H]
        \centering
        \includegraphics[width=1.0\textwidth]{.././assets/5.7.jpg}
    \end{figure}
\end{myconceptblock}
...
\section{§ 6. Foundations of Design and Training of Deep Neural Networks}
...
\subsubsection{SGD Early / Late Stopping}
