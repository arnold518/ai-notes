...
![](.././assets/2.2.png){: .center style="width:70%;"}
...
!!! concept "Concept 2.10 <a id="concept-2-10"></a>: SGD is more efficient than GD."
...
!!! concept "Concept 2.16 <a id="concept-2-16"></a>: How to choose batch size $B$?"
